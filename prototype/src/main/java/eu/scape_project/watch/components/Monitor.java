...
public class Monitor extends Thread implements IMonitor {
  ...
  /*
   * public List<Long> getSleepTime() { return sleepTime; }
   */

  /*
   * public void updateStartTime(int id, Long time) { sleepTime.set(id, time); }
   */
  ...
  public void registerAdaptor(IAdaptor adaptor) {
    AdaptorHolder temp = new AdaptorHolder(adaptorsHolders.size(), this, (Adaptor) adaptor, sleeper); 
