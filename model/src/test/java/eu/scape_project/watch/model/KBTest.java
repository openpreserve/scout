...
public class KBTest {
	...
	private static final String DATA_TYPE_NAME = "Entity type name"
			+ STRANGE_CHARS;
	private static final String DATA_TYPE_DESC = "Entity type description"
			+ STRANGE_CHARS;
	private static final String DATA_PROPERTY_NAME = "Property name"
			+ STRANGE_CHARS;
	private static final String DATA_PROPERTY_DESC = "Property description"
			+ STRANGE_CHARS;
	private static final String DATA_ENTITY_NAME = "Entity name"
			+ STRANGE_CHARS;
	private static final String DATA_SOURCE_NAME = "Source name"
			+ STRANGE_CHARS;
	private static final String DATA_SOURCE_DESCRIPTION = "Source description"
			+ STRANGE_CHARS;
	private static final String DATA_PLUGIN_NAME = "Plugin adaptor"
			+ STRANGE_CHARS;
	private static final String DATA_PLUGIN_VERSION = "0.0.1-SNAPSHOT";
	private static final String DATA_SOURCE_ADAPTOR_INSTANCE = "My default instance"
			+ STRANGE_CHARS;

	private static final String DATA_TYPE_NAME_ALT = "Alternative entity type name"
			+ STRANGE_CHARS;
	private static final String DATA_TYPE_DESC_ALT = "Alternative entity type description"
			+ STRANGE_CHARS;
	...
	public void testEntityTypeCRUD() {
		...
		// List
		final Collection<EntityType> types = Jenabean.instance().reader()
		...
		// LIST AGAIN
		final Collection<EntityType> types3 = Jenabean.instance().reader()
				.load(EntityType.class);
	...
	public void testEntityTypeListeners() {
		...
		final DOListener<EntityType> mockDOListener = Mockito
				.mock(DOListener.class);

		DAO.addDOListener(EntityType.class, mockDOListener);

		final EntityType type1 = new EntityType(DATA_TYPE_NAME, DATA_TYPE_DESC);
		final EntityType type2 = new EntityType(DATA_TYPE_NAME_ALT,
				DATA_TYPE_DESC_ALT);
	...
	public void testPropertyListings() {
		...
		final Collection<Property> properties1 = DAO.PROPERTY.listWithType(
				type.getId(), 0, 100);
	...
	public void testEntityCRUD() {
		...
		// List
		final Collection<Entity> entities = Jenabean.instance().reader()
				.load(Entity.class);
		...
		// FIND
		final Entity entity2 = DAO.ENTITY.findById(type.getName(),
				entity.getName());
		...
		// LIST AGAIN
		final Collection<Entity> entities3 = Jenabean.instance().reader()
				.load(Entity.class);
		...
		// FIND AGAIN
		final Entity entity3 = DAO.ENTITY.findById(type.getName(),
				entity.getName());
	 ...
	 */
	@Test
	public void testPropertyValueEquals() throws UnsupportedDataTypeException,
		...
		final Property property1 = new Property(type1, propertyName,
				propertyDescription, DataType.STRING);
		final Property property2 = new Property(type2, propertyName,
				propertyDescription, DataType.STRING);
		...
		final PropertyValue propertyvalue1 = new PropertyValue(entity1,
				property1, value);
	...
	@Test
	public void testPropertyValueDataTypes()
			throws UnsupportedDataTypeException,
			InvalidJavaClassForDataTypeException {
		...
		final Property stringProperty = new Property(type, "stringProperty",
				"", DataType.STRING);
		final Property integerProperty = new Property(type, "integerProperty",
				"", DataType.INTEGER);
		final Property longProperty = new Property(type, "longProperty", "",
				DataType.LONG);
		final Property floatProperty = new Property(type, "floatProperty", "",
				DataType.FLOAT);
		final Property doubleProperty = new Property(type, "doubleProperty",
				"", DataType.DOUBLE);
		final Property dateProperty = new Property(type, "dateProperty", "",
				DataType.DATE);
		final Property uriProperty = new Property(type, "uriProperty", "",
				DataType.URI);
		final Property stringListProperty = new Property(type,
				"stringListProperty", "", DataType.STRING_LIST);
		final Property stringDictionaryProperty = new Property(type,
				"stringDictionaryProperty", "", DataType.STRING_DICTIONARY);

		final PropertyValue stringPropertyValue1 = new PropertyValue(entity,
				stringProperty, "This is a string");
		final PropertyValue integerPropertyValue1 = new PropertyValue(entity,
				integerProperty, 123);
		final PropertyValue longPropertyValue1 = new PropertyValue(entity,
				longProperty, 123L);
		final PropertyValue floatPropertyValue1 = new PropertyValue(entity,
				floatProperty, 123.1f);
		final PropertyValue doublePropertyValue1 = new PropertyValue(entity,
				doubleProperty, 123.1d);
		final PropertyValue datePropertyValue1 = new PropertyValue(entity,
				dateProperty, new Date());
		final PropertyValue uriPropertyValue1 = new PropertyValue(entity,
				uriProperty, URI.create("http://example.com"));
		final PropertyValue stringListPropertyValue1 = new PropertyValue(
				entity, stringListProperty, Arrays.asList("item1", "item2"));
		final PropertyValue stringDictionaryPropertyValue1 = new PropertyValue(
				entity, stringDictionaryProperty, Arrays.asList(
						new DictionaryItem("key1", "value1"),
						new DictionaryItem("key2", "value2")));

		final Source source = new Source(DATA_SOURCE_NAME,
				DATA_SOURCE_DESCRIPTION);
		final SourceAdaptor adaptor = new SourceAdaptor(DATA_PLUGIN_NAME,
				DATA_PLUGIN_VERSION, DATA_SOURCE_ADAPTOR_INSTANCE, source,
				Arrays.asList(type), Arrays.asList(stringProperty,
						integerProperty, floatProperty, doubleProperty,
						dateProperty, uriProperty, stringListProperty,
		...
		DAO.save(source);
		DAO.save(adaptor);
		DAO.save(stringProperty, integerProperty, longProperty, floatProperty,
				doubleProperty, dateProperty, uriProperty, stringListProperty,
				stringDictionaryProperty);
		DAO.PROPERTY_VALUE.save(adaptor, stringPropertyValue1,
				integerPropertyValue1, longPropertyValue1, floatPropertyValue1,
				doublePropertyValue1, datePropertyValue1, uriPropertyValue1,
				stringListPropertyValue1, stringDictionaryPropertyValue1);

		// TESTING
		final PropertyValue stringPropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), stringProperty.getId());

		Assert.assertEquals(stringPropertyValue1, stringPropertyValue2);

		final PropertyValue integerPropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), integerProperty.getId());

		Assert.assertEquals(integerPropertyValue1, integerPropertyValue2);

		final PropertyValue longPropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), longProperty.getId());

		Assert.assertEquals(longPropertyValue1, longPropertyValue2);

		final PropertyValue floatPropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), floatProperty.getId());

		Assert.assertEquals(floatPropertyValue1, floatPropertyValue2);

		final PropertyValue doublePropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), doubleProperty.getId());

		Assert.assertEquals(doublePropertyValue1, doublePropertyValue2);

		final PropertyValue datePropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), dateProperty.getId());

		Assert.assertEquals(datePropertyValue1, datePropertyValue2);

		final PropertyValue uriPropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), uriProperty.getId());

		Assert.assertEquals(uriPropertyValue1, uriPropertyValue2);

		final PropertyValue stringListPropertyValue2 = DAO.PROPERTY_VALUE.find(
				entity.getId(), stringListProperty.getId());

		Assert.assertEquals(stringListPropertyValue1, stringListPropertyValue2);

		final PropertyValue stringDictionaryPropertyValue2 = DAO.PROPERTY_VALUE
				.find(entity.getId(), stringDictionaryProperty.getId());

		Assert.assertEquals(stringDictionaryPropertyValue1,
				stringDictionaryPropertyValue2);

		// CLEAN UP
		DAO.delete(type);
		DAO.delete(entity);
		DAO.delete(stringProperty, integerProperty, longProperty,
				floatProperty, doubleProperty, dateProperty, uriProperty,
				stringListProperty, stringDictionaryProperty);
		DAO.delete(stringPropertyValue1, integerPropertyValue1,
				longPropertyValue1, floatPropertyValue1, doublePropertyValue1,
				datePropertyValue1, uriPropertyValue1,
				stringListPropertyValue1, stringDictionaryPropertyValue1);
	}
	 ...
	 * 
	 * @throws InvalidJavaClassForDataTypeException
	 *             Unexpected exception when setting a value which java class is
	 *             not compatible with defined property data type.
	 * @throws UnsupportedDataTypeException
	 *             Unexpected exception of unsupported data type.
	 */
	@Test
	public void testPropertyValueDataTypeExceptions()
			throws InvalidJavaClassForDataTypeException,
		...
		property = new Property(type, DATA_PROPERTY_NAME, DATA_PROPERTY_DESC,
				DataType.STRING);
		try {
	 ...
	 */
	@Test
	public void testPropertyValueCRUD() throws UnsupportedDataTypeException,
			InvalidJavaClassForDataTypeException {
		...
		final SourceAdaptor adaptor = new SourceAdaptor(DATA_PLUGIN_NAME,
				DATA_PLUGIN_VERSION, DATA_SOURCE_ADAPTOR_INSTANCE, source,
				Arrays.asList(type), Arrays.asList(property),
				new HashMap<String, String>());
		...
		// List
		final Collection<PropertyValue> pvs = Jenabean.instance().reader()
		...
		// FIND
		final PropertyValue pv2 = DAO.PROPERTY_VALUE.find(entity.getId(),
				property.getId());
		...
		// LIST AGAIN
		final Collection<PropertyValue> pvs3 = Jenabean.instance().reader()
				.load(PropertyValue.class);
		...
		// FIND AGAIN
		final PropertyValue pv3 = DAO.PROPERTY_VALUE.find(entity.getId(),
				property.getId());
	...
	public void testPropertyValueListings()
		...
		final Collection<PropertyValue> pvs1 = DAO.PROPERTY_VALUE
				.listWithEntity(type.getName(), entity.getName(), 0, 100);
		Assert.assertTrue(pvs1.contains(pv));

		final Collection<PropertyValue> pvs2 = DAO.PROPERTY_VALUE
				.listWithProperty(type.getName(), property.getName(), 0, 100);
		Assert.assertTrue(pvs2.contains(pv));

		final Collection<PropertyValue> pvs3 = DAO.PROPERTY_VALUE
				.listWithEntityAndProperty(entity.getId(), property.getId(), 0,
						100);
	...
	@Test
	public void testPropertyValueOrphanListings()
			throws UnsupportedDataTypeException,
			InvalidJavaClassForDataTypeException {
		// CREATE
		final EntityType type = new EntityType(DATA_TYPE_NAME, DATA_TYPE_DESC);
		...
		// Make pv an orphan
		final List<Measurement> measurements = DAO.MEASUREMENT
				.listByPropertyValue(pv, 0, 100);
	 ...
	 */
	@Test
	public void testMeasurements() throws UnsupportedDataTypeException,
			InvalidJavaClassForDataTypeException {
		// CREATE
		final EntityType type = new EntityType();
		type.setName(DATA_TYPE_NAME);
		...
		final Entity entity = new Entity(type, DATA_ENTITY_NAME);
		final Property property = new Property(type, DATA_PROPERTY_NAME,
				DATA_PROPERTY_DESC, DataType.INTEGER);
		...
		final Source source = new Source(DATA_SOURCE_NAME,
				DATA_SOURCE_DESCRIPTION);
		final SourceAdaptor adaptor1 = new SourceAdaptor(DATA_PLUGIN_NAME,
				"0.0.1", DATA_SOURCE_ADAPTOR_INSTANCE, source,
				Arrays.asList(type), Arrays.asList(property),
				new HashMap<String, String>());
		final SourceAdaptor adaptor2 = new SourceAdaptor(DATA_PLUGIN_NAME,
				"0.0.2", DATA_SOURCE_ADAPTOR_INSTANCE, source,
				Arrays.asList(type), Arrays.asList(property),
				new HashMap<String, String>());
		...
		final PropertyValue lastValue = DAO.PROPERTY_VALUE.find(entity.getId(),
				property.getId(), new Date());
		Assert.assertEquals(pv2, lastValue);

		c.set(2004, 6, 1);
		final PropertyValue previousValue = DAO.PROPERTY_VALUE.find(
				entity.getId(), property.getId(), c.getTime());
		Assert.assertEquals(pv1, previousValue);

		// FIND
		final Measurement measurement1 = DAO.MEASUREMENT.findById(
				entity.getName(), property.getName(), date1);
		...
		final Measurement measurement2 = DAO.MEASUREMENT.findById(
				entity.getName(), property.getName(), date2);
		...
		final List<Measurement> listByPropertyValue = DAO.MEASUREMENT
				.listByPropertyValue(pv1, 0, 100);
		Assert.assertTrue(listByPropertyValue.contains(measurement1));
		Assert.assertEquals(1, listByPropertyValue.size());

		final int countByPropertyValue = DAO.MEASUREMENT
				.countByPropertyValue(pv2);
		Assert.assertEquals(1, countByPropertyValue);

		// LIST BY ADAPTOR
		final List<Measurement> listByAdaptor = DAO.MEASUREMENT.listByAdaptor(
				adaptor1, 0, 100);
		...
		// LIST BY SOURCE
		final List<Measurement> listBySource = DAO.MEASUREMENT.listBySource(
				source, 0, 100);
		Assert.assertTrue(listBySource.containsAll(Arrays.asList(measurement1,
				measurement2)));
		...
		// LIST BY PROPERTY
		final List<Measurement> listByProperty = DAO.MEASUREMENT
				.listByProperty(property, 0, 100);
		Assert.assertTrue(listByProperty.containsAll(Arrays.asList(
	...
	public void testAsyncRequestEquals() {
		...
		final Trigger trigger1 = new Trigger(types, properties, entities,
				period, question, plan, notifications);
		...
		// Test found
		final AsyncRequest arequest4 = DAO.ASYNC_REQUEST.findById(arequest1
				.getId());

		Assert.assertTrue(question.equals(arequest4.getTriggers().get(0)
				.getQuestion()));
		Assert.assertTrue(notification.equals(arequest4.getTriggers().get(0)
	 ...
	 */
	@Test
	public void testAsyncRequestCRUD() throws UnsupportedDataTypeException,
			InvalidJavaClassForDataTypeException {
		...
		// List
		final Collection<AsyncRequest> arequests = DAO.ASYNC_REQUEST.list(0,
				100);
		Assert.assertTrue(arequests.contains(arequest));

		// QUERY
		final List<AsyncRequest> arequests2 = DAO.ASYNC_REQUEST.query("", 0,
				100);
		Assert.assertTrue(arequests2.contains(arequest));

		// FIND
		final AsyncRequest arequest2 = DAO.ASYNC_REQUEST.findById(arequest
				.getId());
		...
		// LIST AGAIN
		final Collection<AsyncRequest> arequests3 = DAO.ASYNC_REQUEST.list(0,
				100);
		Assert.assertFalse(arequests3.contains(arequest));

		// QUERY AGAIN
		final List<AsyncRequest> arequests4 = DAO.ASYNC_REQUEST.query("", 0,
				100);
		Assert.assertFalse(arequests4.contains(arequest));

		// FIND AGAIN
		final AsyncRequest arequest3 = DAO.ASYNC_REQUEST.findById(arequest
				.getId());
	 ...
	 */
	@Test
	public void testRequest() throws UnsupportedDataTypeException,
			InvalidJavaClassForDataTypeException {
		...
		final String query1 = EntityDAO.getEntityRDFId(type.getName(),
				entity.getName())
				+ " watch:type ?s";
		final RequestTarget target1 = RequestTarget.ENTITY_TYPE;
		@SuppressWarnings("unchecked")
		final List<PropertyValue> results1 = (List<PropertyValue>) DAO.REQUEST
				.query(target1, query1, 0, 100);
		Assert.assertTrue(results1.contains(type));

		// MAKE PROPERTY REQUEST
		final String query2 = "?s watch:type "
				+ EntityTypeDAO.getEntityTypeRDFId(type);
		final RequestTarget target2 = RequestTarget.PROPERTY;
		@SuppressWarnings("unchecked")
		final List<PropertyValue> results2 = (List<PropertyValue>) DAO.REQUEST
				.query(target2, query2, 0, 100);
		Assert.assertTrue(results2.contains(property));

		// MAKE ENTITY REQUEST
		final String query3 = "?s watch:type "
				+ EntityTypeDAO.getEntityTypeRDFId(type);

		final RequestTarget target3 = RequestTarget.ENTITY;
		@SuppressWarnings("unchecked")
		final List<PropertyValue> results3 = (List<PropertyValue>) DAO.REQUEST
				.query(target3, query3, 0, 100);
		Assert.assertTrue(results3.contains(entity));

		// MAKE PROPERTY VALUE REQUEST
		final String query4 = "?s watch:entity "
				+ EntityDAO.getEntityRDFId(type.getName(), entity.getName())
				+ " . ?s watch:property "
				+ PropertyDAO.getPropertyRDFId(type.getName(),
						property.getName());
		// TODO test " . FILTER(?s < 200)";
		final RequestTarget target4 = RequestTarget.PROPERTY_VALUE;

		@SuppressWarnings("unchecked")
		final List<PropertyValue> results4 = (List<PropertyValue>) DAO.REQUEST
				.query(target4, query4, 0, 100);
	...
	public void testSourceAdaptor() {
		...
		final SourceAdaptor adaptor1v1 = new SourceAdaptor(adaptorName1,
				adaptorVersion1, adaptorInstance, source1, null, null, null);
		final SourceAdaptor adaptor1v2 = new SourceAdaptor(adaptorName1,
				adaptorVersion2, adaptorInstance, source1, null, null, null);
		final SourceAdaptor adaptor2v1 = new SourceAdaptor(adaptorName2,
				adaptorVersion1, adaptorInstance, source2, null, null, null);
		...
		// FIND
		final SourceAdaptor foundAdaptor = DAO.SOURCE_ADAPTOR.findById(
				adaptorName1, adaptorVersion1, adaptorInstance);
		Assert.assertEquals(adaptor1v1, foundAdaptor);

		// QUERY
		final List<SourceAdaptor> list = DAO.SOURCE_ADAPTOR.query("", 0, 100);
		Assert.assertTrue(list.containsAll(Arrays.asList(adaptor1v1,
				adaptor1v2, adaptor2v1)));
		Assert.assertEquals(3, list.size());

		// LIST BY NAME
		final List<SourceAdaptor> listByName = DAO.SOURCE_ADAPTOR.listByName(
				adaptorName1, 0, 100);
		Assert.assertTrue(listByName.containsAll(Arrays.asList(adaptor1v1,
				adaptor1v2)));
		Assert.assertFalse(listByName.contains(adaptor2v1));
		Assert.assertEquals(2, listByName.size());

		// LIST BY SOURCE
		final List<SourceAdaptor> listBySource = DAO.SOURCE_ADAPTOR
				.listBySource(source2, 0, 100);
	...
	public void testActiveSourceAdaptor() {
		...
		final String adaptorVersion2 = "0.0.2";
		final String adaptorInstance = "default";
		final SourceAdaptor adaptor1 = new SourceAdaptor(adaptorName,
				adaptorVersion1, adaptorInstance, source, null, null, null);
		final SourceAdaptor adaptor2 = new SourceAdaptor(adaptorName,
				adaptorVersion2, adaptorInstance, source, null, null, null);
		...
		// QUERY ACTIVE
		final List<SourceAdaptor> list = DAO.SOURCE_ADAPTOR.queryActive(true,
				0, 100);
		Assert.assertTrue(list.containsAll(Arrays.asList(adaptor1)));
		Assert.assertEquals(1, list.size());

		// QUERY INACTIVE
		final List<SourceAdaptor> list2 = DAO.SOURCE_ADAPTOR.queryActive(false,
				0, 100);
	 ...
	 */
	@Test
	public void testSourceAdaptorCascadeDelete()
			throws UnsupportedDataTypeException,
			InvalidJavaClassForDataTypeException {
		final Source source = new Source(DATA_SOURCE_NAME,
				DATA_SOURCE_DESCRIPTION);
		...
		final SourceAdaptorEvent event = new SourceAdaptorEvent(
				SourceAdaptorEventType.EXECUTED, "scheduled execution", true,
				"", new Date(), adaptor);
		...
		final int orphanPropertiesCount = DAO.PROPERTY_VALUE
				.countMeasurementOrphan();
		Assert.assertEquals(0, orphanPropertiesCount);

		final int eventsCount = DAO.SOURCE_ADAPTOR_EVENT
				.countByAdaptor(adaptor);
